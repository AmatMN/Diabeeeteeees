...
public class FirstFragment extends Fragment {
    ...
    /*
    This function updates the first fragment with the data last received through setData()
    ...
    */
    ...
    /*
    setData() sets the data to be displayed
    Actually updating the screen is handled by update()
    */
    ...
    /*
    If the view is initialized, set the log of the first view
    String log is the already existing log read from the file
    */
    @SuppressLint("SetTextI18n")
